            ...
            if request.method == "POST":
                ...
                if request.user.usertracking.is_blocked():
                    messages.error(request,
                                   f"You can't add post Since you are blocked to "
                                   f"{request.user.usertracking.date_of_end_block.date()}\n"
                                   f"because you post a lot of censored words."
                                   f"date of block is {request.user.usertracking.date_of_start_block.date()}")
